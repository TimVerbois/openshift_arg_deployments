           ...
           openshift.withProject() {
             withDockerRegistry([url: "docker-registry.default.svc:5000/ci00000000-argentatest-01"]) {
               withDockerRegistry([url: "docker-registry.default.svc:5000/ci00000000-argentatest-02"]) {
                 ...
                 """
//                    docker pull docker-registry.default.svc:5000/ci00000000-argentatest-01/helloworld2:${version}
//                   docker tag docker-registry.default.svc:5000/ci00000000-argentatest-01/helloworld2:${version} docker-registry.default.svc:5000/ci00000000-argentatest-02/helloworld2:${version}
//                    docker push docker-registry.default.svc:5000/ci00000000-argentatest-02/helloworld2:${version}
               }
             }
           }
         }
